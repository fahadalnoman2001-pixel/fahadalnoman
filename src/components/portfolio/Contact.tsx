            ...
            {[
              ...
              const content = (
                <>
                  ...
                  <div 
                    className="min-w-0"
                    {...(isLocation ? { itemProp: "address", itemScope: true, itemType: "https://schema.org/PostalAddress" } : {})}
                  >
                    ...
                    <div 
                      ...
                      {...(isLocation ? { itemProp: "streetAddress" } : {})}
                    >
                      {value}
                    </div>
                  </div>
              ...
              const Wrapper = isLocation ? "address" : "div";
              return href ? (
                <a
                  key={label}
                  href={href}
                ...
                <Wrapper key={label} className="flex items-center gap-4 rounded-2xl border border-border bg-surface p-4 not-italic">
                  {content}
                </Wrapper>
              );
            })}
