...
{`const developer = {
  ...
  `}<span className="text-accent">role</span>{`: `}<span className="text-amber">"Full-Stack Dev + DevOps"</span>{`,
  `}<span className="text-accent">based</span>{`: `}<span className="text-amber">"Malta 🇲🇹"</span>{`,
  `}<span className="text-accent">stack</span>{`: [`}<span className="text-amber">"React"</span>{`, `}<span className="text-amber">"Laravel"</span>{`, `}<span className="text-amber">"Docker"</span>{`],
